...
public class SubscriberController {
	 ...
	 @Autowired 
	    ...
	    public String movies(Subscriber subscriber)
	    {
	    	return "subscriber/movies";
	    }
	    
	    @GetMapping(value="/tv")
	    public String tv(Subscriber subscriber)
	    {
	    	return "subscriber/tv";
	    } 
	    
	    @GetMapping(value="/actor")
	    public String actor(Subscriber subscriber)
	    {
